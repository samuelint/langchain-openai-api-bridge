...
from tests.test_functional.fastapi_assistant_agent_llamacpp.my_llamacpp_agent_factory import (
    MyLlamacppAgentFactory,
)
...
app = FastAPI(
    title="LLamaCPP Langchain Agent OpenAI API Bridge",
    version="1.0",
...
bridge = LangchainOpenaiApiBridgeFastAPI(
    app=app, agent_factory_provider=lambda: MyLlamacppAgentFactory()
)
